...
## UPDATE
```bash
curl --connect-timeout 1 --max-time 3SL https://raw.githubusercontent.com/arivpnstores/BotVPN/main/update.sh -o update.sh && chmod +x update.sh && bash update.sh
```
...
```
-
## DATA QRIS ORDER KUOTA
https://scanqr.org/

## CEK PEMBAYARAN ORKUT 
